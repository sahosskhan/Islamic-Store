...
<main class="flex justify-center items-start gap-10 my-[53px]">
    <div class="max-w-2xl">
...
<div class="w-full max-w-2xl overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    ...
    <div class="px-6 py-4">
        ...
        <h1 class="text-xl font-bold text-green-700 ">${{$items->productprice}}</h1>
        </div>
      ...
      <a class="px-6 py-2 m text-2xl font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-amber-500 rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">Add To Cart</a>
