...
<section class="max-w-screen-xl my-10 container mx-auto grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
...
<div class="max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    ...
    <div class="flex items-center justify-between px-4 py-2 bg-gray-900">
        <h1 class="text-lg font-bold text-white">${{$item->productprice}}</h1>
